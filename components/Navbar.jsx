  ...
  return (
    <div className='bg-[#F5F5F5] w-full h-[100px] sticky top-0 z-10 flex justify-between items-center px-30 max-sm:px-5 transition-all duration-300 ease-in-out'>
      ...
      <div className='flex w-[358px] justify-between font-[400] items-center max-sm:hidden'>
       <Link href={'/discover'} className='flex items-center gap-[8px] cursor-pointer hover:font-semibold'>Discover</Link>
        ...
        <Link href={'/about'} className={`flex items-center gap-[8px] cursor-pointer hover:font-semibold`} style={{fontWeight: page==='about' && '600'}}>About</Link>
      </div>
