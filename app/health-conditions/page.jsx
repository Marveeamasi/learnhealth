...
export default function HealthConditionPage() {   
  ...
  <div className="flex w-full flex-col">
   <Navbar page={'health conditions'}/>
   <section className="px-30 py-20 flex flex-col gap-5">
    <div className="flex items-center gap-2 text-[16px] text-[#979797]">
        <span>Home</span><RiArrowRightSLine/><span>Health Conditions</span><RiArrowRightSLine/><span>{selectedAlphabet}</span>
    </div>
    <div className="font-[700] text-[48px]">Health Conditions & Topics</div>
    <p className="font-[400] text-[16px] max-w-[455px]">Browse our vast range of health conditions and find information
